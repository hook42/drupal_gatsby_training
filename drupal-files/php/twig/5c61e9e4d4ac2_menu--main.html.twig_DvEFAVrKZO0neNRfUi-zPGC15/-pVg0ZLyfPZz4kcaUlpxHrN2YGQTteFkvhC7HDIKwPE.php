...
class __TwigTemplate_d8643694de1d9cd330afd0a73606940235fa26a37bd8fa5577bc2db2d743b655 extends Twig_Template
{
...
($context["menu_name"] ?? null))) . "__submenu")];
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 49
                    echo "      <ul";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["menu_classes"] ?? null)], "method"), "setAttribute", [0 => "data-drupal-selector", 1 => "menu-main"], "method"), "html", null, true));
                    echo "> ";
                    // line 50
                    echo "    ";
                } else {
...
$context["item"], "attributes", []), "removeClass", [0 => ($context["item_classes"] ?? null)], "method"), "addClass", [0 => ($context["link_classes"] ?? null)], "method")), "html", null, true));
  ...
  ";
    ...
    {
        return new Twig_Source("", "core/profiles/demo_umami/themes/umami/templates/components/navigation/menu--main.html.twig", "/app/web/core/profiles/demo_umami/themes/umami/templates/components/navigation/menu--main.html.twig");
    }
}
